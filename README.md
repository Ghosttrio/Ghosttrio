<!-- ### 🙂 안녕하세요! **배움**을 즐기는 백엔드 개발자 박창순입니다.

- [블로그](https://ghosttrio.github.io), [깃허브](https://github.com/Ghosttrio), [노션]() 등 **개발 향상심** 가지고 **기록**을 하여 개발 역량을 발전시킵니다.
- 실무 경험과 대외 활동 경험을 통해 **원활한 소통**이 가능합니다.
- 스타트업 환경에서 **스스로 업무를 주도**하며 팀 공동 목표에 기여했습니다.
- **읽기 좋은** 코드, **쉽고 간단한** 코드가 좋은 코드라고 생각합니다. -->
...
![Jenkins](https://img.shields.io/badge/Jenkins-326CE5?style=for-the-badge&logo=Jenkins&logoColor=white)
